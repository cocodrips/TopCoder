...
def do_test(a, b, c, __expected):
    startTime = time.time()
    instance = FortunateNumbers()
    exception = None
    try:
        __result = instance.getFortunate(a, b, c);
    except:
        import traceback
...
def run_tests():
    sys.stdout.write("FortunateNumbers (250 Points)\n\n")
    ...
    with open("FortunateNumbers.sample", "r") as f:
        while True:
            label = f.readline()
