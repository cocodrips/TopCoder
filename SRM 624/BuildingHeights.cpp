...
// CUT begin
ifstream data("BuildingHeights.sample");
...
bool do_test(vector<int> heights, int __expected) {
    ...
    BuildingHeights *instance = new BuildingHeights();
    int __result = instance->minimum(heights);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "BuildingHeights (250 Points)" << endl << endl;
    }
