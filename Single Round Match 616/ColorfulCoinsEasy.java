...
public class ColorfulCoinsEasy {
	public String isPossible(int[] values) {
        ...
        int[] maxNums = new int[values.length-1];
        for (int i = 0; i < values.length-1; i++){
            maxNums[i] = values[i+1] / values[i];
        }
        Arrays.sort(maxNums);
...
// CUT begin
	public static void main(String[] args){
		System.err.println("ColorfulCoinsEasy (600 Points)");
		System.err.println();
	...
	static class Reader {
        private static final String dataFileName = "ColorfulCoinsEasy.sample";
